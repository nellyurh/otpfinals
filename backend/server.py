...
async def ercaspay_initiate_payment(payload: ErcaspayInitiateRequest, user: dict = Depends(get_current_user)):
    ...
    # Map payment method to Ercaspay format (comma-separated string)
...
async def get_public_branding():
    ...
    return {
        ...
        "reseller_api_base_url": config.get("reseller_api_base_url", "https://sms-gateway-17.preview.emergentagent.com"),
