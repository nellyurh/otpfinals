...
async def ercaspay_initiate_payment(payload: ErcaspayInitiateRequest, user: dict = Depends(get_current_user)):
    ...
    frontend_url = os.environ.get('REACT_APP_BACKEND_URL', FRONTEND_URL) or 'https://otp-relay-2.preview.emergentagent.com'
...
async def get_public_branding():
    ...
    return {
        ...
        "reseller_api_base_url": config.get("reseller_api_base_url", "https://otp-relay-2.preview.emergentagent.com"),
    }
