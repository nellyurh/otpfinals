...
import { Phone, ChevronDown, RefreshCw, Copy, Check, AlertCircle, Star } from 'lucide-react';
import axios from 'axios';
import { toast } from 'sonner';

const API = process.env.REACT_APP_BACKEND_URL;

// Provider card data for US Numbers
const US_PROVIDERS = [
  {
    id: 'textverified',
    name: 'Text Verified',
