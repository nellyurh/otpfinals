      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button onClick={() => navigate('/login')} style={{ background: 'transparent', border: 'none', color: '#1a1a1a', fontWeight: 500, fontSize: '15px', cursor: 'pointer' }}>Login</button>
            <button onClick={() => navigate('/register')} style={{ background: primaryColor, border: 'none', borderRadius: '8px', padding: '10px 24px', color: 'white', fontWeight: 600, fontSize: '15px', cursor: 'pointer' }}>Sign Up</button>
          </div>
        </div>
      </nav>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                <button onClick={() => navigate('/register')} style={{ background: primaryColor, border: 'none', borderRadius: '10px', padding: '14px 32px', color: 'white', fontWeight: 600, fontSize: '16px', cursor: 'pointer' }}>Register Now</button>
